...
{
    public partial class frmReportSummaryOfStudentsAttendances : Form
    {
        ...
        public frmReportSummaryOfStudentsAttendances()
        {
            InitializeComponent();
        }
        ...
        private void frmReportSummaryOfStudentsAttendances_Load(object sender, EventArgs e)
        {
            PopulateCBTeachers();
